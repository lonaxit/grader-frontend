...
export default {
    ...
    methods:{
        ...mapActions(['ADD_RESUMPTION','ALL_SESSIONS','ALL_TERMS']),
        handleSubmit(){
            this.submitting = true;

                if(this.next_term_begins === ''){
               this.submitting = false;
                 this.$notify({
                        title:'Error',
                        text:'Enter resumption date',
                        duration:5000,
                        type: 'error',
                        width:'100%',
                    })
              ...
              if(this.current_term_ends === ''){
               this.submitting = false;
                 this.$notify({
                        title:'Error',
                        text:'Enter date ending for current term',
                        duration:5000,
                        type: 'error',
                        width:'100%',
                    })
            ...
            // data
               const payload ={
                ...
                this.ADD_RESUMPTION(payload).then((res)=>{
