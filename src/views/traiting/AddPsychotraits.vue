...
<div class="col-sm-12 col-xl-8">
  <h4>Add Student Psycho Traits</h4>
...
export default {
    ...
    methods:{
        ...mapActions(['ALL_SESSIONS','ALL_CLASSES','ALL_TERMS','ADD_PSYCHOTRAITS']),
        handleSubmit(){
            ...
            // data
               const payload ={
                ...
                this.ADD_PSYCHOTRAITS(payload).then((res)=>{
                 
                    this.submitting = false
                        this.$notify({
                        title:'Success',
                        text:'Traits created successfully',
                        duration:5000,
                        type: 'success',
                        width:'100%',
                    })
